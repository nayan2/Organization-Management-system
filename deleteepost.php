...
<div class="list">
		...
		<div class="contain">
			<h3>Delete Employee Post</h3>
			<small><?php if(isset($_SESSION['invaliddp'])) { echo $_SESSION['invaliddp'];  unset($_SESSION['invaliddp']);}?></small>
			<form method="post" action="function/function.php">
			<select name="deleteemployeepost" class="select">
			<?php 
